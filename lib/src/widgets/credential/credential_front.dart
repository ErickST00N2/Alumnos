                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: Text(
                                    ...
                                    'No. DE CONTROL: ${databaseUser.numControl}',
                ...
                child: Center(
                  child: RotatedBox(
                    ...
                    child: AutoSizeText(
                      ...
                      "${databaseUser.especialidad.toString().toUpperCase()} ${databaseUser.semestre.toString().toUpperCase()}° ${databaseUser.grupo.toString().toUpperCase()}",
                      maxLines: 1,
                      style: const TextStyle(
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
